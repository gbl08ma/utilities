...
#define SETTING_FILE_MANAGER_SEARCH 24
#define SETTING_TIMEZONE 25

#define NUMBER_OF_SETTINGS 25 //NOTE update this when adding settings. DOES NOT include the SETTING_SELF_FILEVERSION
/*End of settings*/ 
